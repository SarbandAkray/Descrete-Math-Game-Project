...
//player voice
var level2 = new Audio('../playervoice/level2.wav');
var level2end = new Audio('../playervoice/level2end.wav');
level2.play();
 ...
 anime({
    targets: player,
    translateX: [
        { value: 250, duration: 1500, delay: 500,easing:'linear'},
      ],
    loop:false,
    begin:function(){
      footstep.play();
