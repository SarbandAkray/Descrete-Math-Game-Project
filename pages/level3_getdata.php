<?php
    ...
    $input = array("event-probability","permutation","multiplication-rule","combination","conditional-probability","probability-union","probability-complement","bayes-theorem");
